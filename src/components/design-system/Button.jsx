    ...
    render(props) {
        ...
        return <Fade left={true}  duration={500} delay={500} distance="30px">
            <a href={ "" + this.props.href }>
                <div type="button" className={"cursor-none flex rounded-full py-2 xl:py-4 w-auto transform z-40 hover:scale-125 duration-150 hover:-rotate-6" + selectedTheme.bg + selectedTheme.border }>
